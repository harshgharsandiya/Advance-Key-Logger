...
# make it hidden and non guessable
...
#password = "aaaa aaaa aaaa aaaa" --> Replace with your gmail 16 digit app code
...
#You can encrypt and decrypt your data using this key
...
def send_email(filename, attachment, toaddr):
    ...
    p.add_header('Content-Type', "attachment; filename= %s" % filename)
